    ...
    <div>
      <el-menu default-active="3" class="el-menu-demo" mode="horizontal">
        ...
        <el-menu-item index="2" @click="$router.replace('/arrm')"
          >工作安排管理</el-menu-item
        >
        <el-menu-item index="3">健康打卡管理</el-menu-item>
...
<script>
import { reqQueryHealth } from "../../api";
export default {
  data() {
    return {
  ...
  methods: {
    ...
    async query(isquery) {
      ...
      result = await reqQueryHealth(obj);
      if (result) {
